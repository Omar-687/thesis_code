 def __init__(self,
        ...
        problems when evs depart quickly - need to change smoothing because it works
        with high previous values doesnt take into account that evs are no longer there