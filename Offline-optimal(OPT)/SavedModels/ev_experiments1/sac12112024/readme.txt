quite ok mse but should be improved, mpe too 0.3 is too high for beta 1e6
...
class EVenvironment(gymnasium.Env):
    ...
    def __init__(self,
        ...
        change gamma to higher so possibly the signals chosen will better approximate because of taking into account future
        reward 0.99
