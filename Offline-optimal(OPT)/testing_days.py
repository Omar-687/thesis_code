...
# training from ondata collected from Nov. 1, 2018 to Dec. 1, 2019

start_training = datetime(2018, 11, 1, 0, 0, 0,tzinfo=timezone.utc)
end_training = datetime(2019, 12, 1, 23, 59, 59, tzinfo=timezone.utc)
ut_interval = [0 , 150]
...
# ondata from Dec. 2, 2019 to an.1,2020

start_testing = datetime(2019, 12, 2, 0, 0, 0,tzinfo=timezone.utc)
end_testing = datetime(2019, 1, 1, 23, 59, 59, tzinfo=timezone.utc)
ut_interval = [0 , 150]
maximum_charging_rate = 6.6
number_of_evse = 54
period = 12
